# Gerando Word Embeddings Estáticas para o córpus de texto dos projetos da Embrapa com FastText
...
ft_embeddings = FastText(sentencas, 
                         min_count=int(sys.argv[2]),                 # Ignora palavras que ocorrem menos de 3 vezes
